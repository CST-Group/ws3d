 ...
 * @author eccastro
 */
public class EditJewelFrame extends JFrame {
    ...
    public void setObstacle(Thing obstac) {
        this.jewel = (Jewel) obstac;
        ta.setText("         "+this.jewel.getMyName());
        ...
        hiddenObstacle.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(EditJewelFrame.this, "Error in jewel execution.", "ERRO", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
